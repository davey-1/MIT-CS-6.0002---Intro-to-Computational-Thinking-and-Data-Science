...
class RectangularRoom(object):
    ...
    #***Q***: Where do we initialize tiles?
    ...
    def __init__(self, width, height, dirt_amount):
        ...
        #**Q: Do we initialize define tiles here too?
        #**Q: do we need to/can we check if the above values meet the criteria in init?
        #and raise an error if not?  ...or, assume the constraints are already met?
        
        '''
        if width < 1 or height < 1 or dirt_amount < 0: 
            raise ValueError("One of the room parameters <0")
        '''
    ...
    def clean_tile_at_position(self, pos, capacity):
        ...
        #**Q: have we defined tile already or not?
        #Pseudocode:  find the tile with the corresponding position
        #reduce dirt amount by capacity
        
        math.floor(pos.get_x())
        math.floor(pos.get_y())
        
        
        self.dirt_amount = self.dirt_amount - capacity
